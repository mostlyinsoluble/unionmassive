...
internal class LanguageServerEndpointAttribute(string method, string language, params string[] additionalLanguages) : Attribute
{
    /// <summary>
    ...
    /// </summary>
    public string[] Languages { get; } = [language, .. additionalLanguages];
