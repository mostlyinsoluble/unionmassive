...
internal sealed class InitializeHandler<TRequest, TResponse, TRequestContext>(IInitializeManager<TRequest, TResponse> capabilitiesManager)
    : IRequestHandler<TRequest, TResponse, TRequestContext>
{
    private readonly IInitializeManager<TRequest, TResponse> _capabilitiesManager = capabilitiesManager;
