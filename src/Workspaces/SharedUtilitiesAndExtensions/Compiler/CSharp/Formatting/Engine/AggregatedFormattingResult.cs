...
internal sealed class AggregatedFormattingResult(SyntaxNode node, IList<AbstractFormattingResult> results, TextSpanMutableIntervalTree? formattingSpans) : AbstractAggregatedFormattingResult(node, results, formattingSpans)
{
