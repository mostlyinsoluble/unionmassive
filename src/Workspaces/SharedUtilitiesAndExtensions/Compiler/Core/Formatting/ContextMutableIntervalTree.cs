...
/// </summary>
internal sealed class ContextMutableIntervalTree<T, TIntrospector>(in TIntrospector introspector) : SimpleMutableIntervalTree<T, TIntrospector>(introspector, values: null)
