    ...
    private sealed partial class Editor
    {
        ...
        private bool IsSymbolAccessible(ISymbol symbol)
        {
            ...
            return symbol.DeclaredAccessibility switch
            {
                ...
                Accessibility.ProtectedAndInternal or Accessibility.Internal => _semanticDocument.SemanticModel.Compilation.Assembly.IsSameAssemblyOrHasFriendAccessTo(
                                        symbol.ContainingAssembly),// TODO: Code coverage
                _ => false,
            };
        }
    }
