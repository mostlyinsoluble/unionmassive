...
/// </summary>
internal abstract class AbstractConfigurationActionWithNestedActions(ImmutableArray<CodeAction> nestedActions, string title) : CodeAction.CodeActionWithNestedActions(title, nestedActions, isInlinable: false,
