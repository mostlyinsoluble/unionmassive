...
internal sealed class CSharpCodeCleanUpFixerProvider(
    [ImportMany] IEnumerable<Lazy<AbstractCodeCleanUpFixer, ContentTypeMetadata>> codeCleanUpFixers) : AbstractCodeCleanUpFixerProvider(codeCleanUpFixers)
{
}
