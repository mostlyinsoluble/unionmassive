...
/// </summary>
internal sealed class WorkspaceFileTextLoaderNoException(SolutionServices services, string path, Encoding defaultEncoding) : WorkspaceFileTextLoader(services, path, defaultEncoding)
{
