...
internal sealed partial class WhitespaceViewModel(ISettingsProvider<Setting> data,
    ...
    WhitespaceViewModel.SettingsEntriesSnapshot>(data, controlProvider, tableMangerProvider)
{
