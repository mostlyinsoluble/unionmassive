...
namespace Microsoft.CodeAnalysis.Diagnostics
{
    ...
    public sealed class SyntaxTreeValueProvider<TValue>(Func<SyntaxTree, TValue> computeValue, IEqualityComparer<SyntaxTree>? syntaxTreeComparer = null)
    {
        internal AnalysisValueProvider<SyntaxTree, TValue> CoreValueProvider { get; private set; } = new AnalysisValueProvider<SyntaxTree, TValue>(computeValue, syntaxTreeComparer ?? SyntaxTreeComparer.Instance);
    }
}
