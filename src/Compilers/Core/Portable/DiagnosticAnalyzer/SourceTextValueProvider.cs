...
namespace Microsoft.CodeAnalysis.Diagnostics
{
    ...
    public sealed class SourceTextValueProvider<TValue>(Func<SourceText, TValue> computeValue, IEqualityComparer<SourceText>? sourceTextComparer = null)
    {
        internal AnalysisValueProvider<SourceText, TValue> CoreValueProvider { get; private set; } = new AnalysisValueProvider<SourceText, TValue>(computeValue, sourceTextComparer ?? SourceTextComparer.Instance);
    }
}
