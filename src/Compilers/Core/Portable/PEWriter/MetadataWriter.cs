...
namespace Microsoft.Cci
{
    internal abstract partial class MetadataWriter
    {
        ...
        private readonly TypeReferenceHandle[,] _dummyAssemblyAttributeParent = { { default, default }, { default, default } };
        ...
        {
            if (this.TryGetTypeReferenceHandle(typeReference, out TypeReferenceHandle result))
            {
                return result;
            }
...
#nullable enable
        public void WriteMetadataAndIL(PdbWriter? nativePdbWriterOpt, Stream metadataStream, Stream ilStream, Stream? portablePdbStreamOpt, out MetadataSizes metadataSizes)
        {
            ...
            // stream.
            Debug.Assert(module.SerializationProperties.PersistentIdentifier != default);
...
#nullable disable
        ...
        internal void GetEntryPoints(out MethodDefinitionHandle entryPointHandle, out MethodDefinitionHandle debugEntryPointHandle)
        {
            if (IsFullMetadata)
            {
                ...
                entryPointHandle = entryPoint != null ? (MethodDefinitionHandle)GetMethodHandle((IMethodDefinition)entryPoint.AsDefinition(Context)) : default;
...
#nullable disable
        ...
        private int SerializeMethodBody(MethodBodyStreamEncoder encoder, IMethodBody methodBody, StandaloneSignatureHandle localSignatureHandleOpt, ref UserStringHandle mvidStringHandle, ref Blob mvidStringFixup)
        {
            ...
            if (!_deterministic && isSmallBody && _smallMethodBodies.TryGetValue(smallBodyKey, out int bodyOffset))
            {
                return bodyOffset;
            }
...
#if DEBUG
                Debug.Assert(!this.TryGetValue(item, out int i));
#endif
