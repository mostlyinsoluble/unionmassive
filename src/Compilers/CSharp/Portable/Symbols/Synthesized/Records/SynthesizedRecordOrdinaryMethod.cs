...
namespace Microsoft.CodeAnalysis.CSharp.Symbols
{
    ...
    /// </summary>
    internal abstract class SynthesizedRecordOrdinaryMethod(SourceMemberContainerTypeSymbol containingType, string name, int memberOffset, DeclarationModifiers declarationModifiers) : SynthesizedSourceOrdinaryMethodSymbol(containingType, name, containingType.GetFirstLocation(), (CSharpSyntaxNode)containingType.SyntaxReferences[0].GetSyntax(),
