...
namespace Microsoft.CodeAnalysis.FlowAnalysis.DataFlow.ValueContentAnalysis
{
    ...
    public partial class ValueContentAnalysis : ForwardDataFlowAnalysis<ValueContentAnalysisData, ValueContentAnalysisContext, ValueContentAnalysisResult, ValueContentBlockAnalysisResult, ValueContentAbstractValue>
    {
        ...
        /// </summary>
        private sealed class ValueContentDataFlowOperationVisitor(ValueContentAnalysis.ValueContentAnalysisDomain valueContentAnalysisDomain, ValueContentAnalysisContext analysisContext) : PredicateAnalysisEntityDataFlowOperationVisitor<ValueContentAnalysisData, ValueContentAnalysisContext, ValueContentAnalysisResult, ValueContentAbstractValue>(analysisContext)
        {
