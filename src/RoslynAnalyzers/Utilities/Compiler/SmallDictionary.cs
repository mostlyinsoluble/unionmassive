...
#pragma warning disable CA1063, CA1816 // Implement IDisposable Correctly
            public sealed class EnumerableCore(KeyCollection.Enumerator e) : IEnumerator<K>
            {
        ...
        internal readonly struct ValueCollection(SmallDictionary<K, V> dict) : IEnumerable<V>
        {
            ...
            public sealed class EnumerableCore(ValueCollection.Enumerator e) : IEnumerator<V>
            {
                private Enumerator _e = e;
        ...
        public sealed class EnumerableCore(SmallDictionary<K, V>.Enumerator e) : IEnumerator<KeyValuePair<K, V>>
        {
            private Enumerator _e = e;
